<div class="col-12 py-5 text-center">
  <form action="<?=BASE_URL."/produto/cadastrar"?>" method="POST" class="col-6 mx-auto">
    <div class="form-group">
      ...
      <input type="text" name="preco_compra" class="form-control" type="number" step="0.01" placeholder="Preço de Compra">
      <input type="text" name="preco_venda" class="form-control" type="number" step="0.01" placeholder="Preço de Venda">
      <input type="text" name="quantidade" class="form-control" type="number" step="1" placeholder="Quantidade">
